...
namespace Maticsoft.DAL
{
	...
	public partial class UsersInfo
	{
		...
		public bool Update(Maticsoft.Model.UsersInfo model)
		{
			...
			if (model.AAA1 != null)
			{
				strSql.Append("AAA1='"+model.AAA1+"',");
			}
			else
			{
				strSql.Append("AAA1= null ,");
			}
			if (model.AAA2 != null)
			{
		...
		public Maticsoft.Model.UsersInfo GetModel(string UserID)
		{
			...
			strSql.Append(" UserID,UnitID,UserName,UserPassword,UserRealName,UserSex,UserEmail,UserProvince,UserCity,UserBirthday,UserPhone,UserAddress,UserIdentity,AAA1,AAA2,AAA3,AAA4,AAA5 ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select UserID,UnitID,UserName,UserPassword,UserRealName,UserSex,UserEmail,UserProvince,UserCity,UserBirthday,UserPhone,UserAddress,UserIdentity,AAA1,AAA2,AAA3,AAA4,AAA5 ");
			strSql.Append(" FROM UsersInfo ");
			if(strWhere.Trim()!="")
			{
