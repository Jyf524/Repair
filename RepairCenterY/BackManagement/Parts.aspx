<%@ Page Title="配件管理" Language="C#" MasterPageFile="~/BackManagement/RepairCenter.Master" AutoEventWireup="true" CodeBehind="Parts.aspx.cs" Inherits="RepairCenterY.BackManagement.Parts" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script type="text/javascript">
        ...
        function OpenAddPro() {
            var oWnd = radopen("PartsAdd.aspx", "RadWindowManager1");
        ...
        function Openxg() {
            if (-1 == id) {
                ...
                oWnd = radopen("PartsEdit.aspx?ID=" + id, "RadWindowManager1");
                oWnd.setSize(500, 300);
                oWnd.center();
                oWnd.show();
            }
        ...
        function OpenHistoryLook() {
            if (-1 == id) {
                window.alert("请选择一条数据!");
            }
            else {
                window.location.href = "PartsHistory.aspx?ID=" + id;
            }
        }
            ...
            <div class="panel-body">
                        ...
                        <div class="panel-body">
                            <div class="navbar-form navbar-left" style="margin-top: -20px;">
                                <div class="input-group">
                                    <div style="float: left; line-height: 34px;">配件名称：</div>
                                    <div style="float: left; margin-left: 10px;">
                                        <telerik:RadTextBox ID="txtPartName" runat="server" CssClass="form-control" LabelWidth="64px" Resize="None" Width="200px" Height="34"></telerik:RadTextBox>
                                    </div>
                                </div>
                            ...
                            <div style="margin-top: 50px;">
                                <telerik:RadGrid ID="RadGrid1" runat="server" OnNeedDataSource="RadGrid1_NeedDataSource1" OnPageIndexChanged="RadGrid1_PageIndexChanged" OnItemCommand="RadGrid1_ItemCommand" Skin="Metro">
                                    ...
                                    <MasterTableView NoMasterRecordsText="暂无数据" AllowPaging="true" DataKeyNames="PartID" PageSize="10" AutoGenerateColumns="false" ClientDataKeyNames="PartID">
                                        <Columns>
                                            ...
                                            <telerik:GridBoundColumn DataField="PartTypeName" HeaderText="配件类别"></telerik:GridBoundColumn>
                                            <telerik:GridTemplateColumn HeaderText="操作">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="LinkButton1" runat="server" OnClientClick="return deletepart()" CommandName="Delete" CommandArgument='<%#Eval("PartID") %>'>删除</asp:LinkButton>
                                                </ItemTemplate>
                                            </telerik:GridTemplateColumn>
                                        </Columns>
                                    </MasterTableView>
                ...
                <div class="panel-body">
                    <p class="demo-button" style="float: right;">
                        ...
                        <asp:Button ID="btnlook" runat="server" CssClass="btn btn-default" Text="查看使用记录" />
