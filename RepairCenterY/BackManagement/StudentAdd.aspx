<%@ Page Title="学生添加页" Language="C#" MasterPageFile="~/BackManagement/RepairCenter.Master" AutoEventWireup="true" CodeBehind="StudentAdd.aspx.cs" Inherits="RepairCenterY.BackManagement.StudentAdd" %>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                                    <ContentTemplate>
                                <asp:RadioButton ID="xingbeinan" runat="server"  Text="男" Checked="True" GroupName="1"/>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                   <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                                    <ContentTemplate>
                                <asp:DropDownList ID="Suoshusheng" runat="server" CssClass="form-control" Width="500px" OnLoad="Suoshusheng_Load" OnSelectedIndexChanged="Suoshusheng_SelectedIndexChanged" AppendDataBoundItems="true" AutoPostBack="true">
                                </asp:DropDownList>
                                <div style="float: left; margin-left: 515px; margin-top: -35px;">
                                    <asp:DropDownList ID="Suoshushi" runat="server" CssClass="form-control" Width="500px" AppendDataBoundItems="true" AutoPostBack="true">
                                    </asp:DropDownList>
                                    </ContentTemplate>
                                </asp:UpdatePanel>
                                </div>
