<%@ Page Title="报修单位添加" Language="C#" MasterPageFile="~/BackManagement/RepairCenter.Master" AutoEventWireup="true" CodeBehind="CompanyAdd.aspx.cs" Inherits="RepairCenterY.BackManagement.CompanyAdd" %>
    ...
    <div class="panel panel-headline" style="width: 95%; height: 500px; background-color: #fff; margin-left: 2.5%;">
        <div class="panel-heading">
            <div style="float: left;">
                <h3 class="panel-title">报修单位添加</h3>
            </div>
            <div style="float: left;">
                <p class="panel-subtitle" style="line-height: 2; margin-left: 5px; font-weight: 100;">Reporting Add</p>
            </div>
        </div>
                ...
                <div class="form-three widget-shadow">
                    <div class="form-horizontal">
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="TextBox5" runat="server" CssClass="form-control"  MaxLength="30" ReadOnly="true"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="TextBox3" runat="server" CssClass="form-control"   MaxLength="30"></asp:TextBox>
                            </div>
                        </div>
                         <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">联系方式：</label>
                            <div class="col-sm-8">
                                <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control"   MaxLength="30"></asp:TextBox>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="focusedinput" class="col-sm-2 control-label">单位地址：</label>
                            <div class="col-sm-8">
                                <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" Width="49%" OnLoad="DropDownList1_Load" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged" AppendDataBoundItems="True" AutoPostBack="True"></asp:DropDownList>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-8">
                                <asp:TextBox ID="TextBox4" runat="server" CssClass="form-control"   MaxLength="30"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                </div>
