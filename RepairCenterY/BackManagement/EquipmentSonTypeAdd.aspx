<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentSonTypeAdd.aspx.cs" Inherits="RepairCenterY.BackManagement.EquipmentSonTypeAdd" %>
    ...
    <form id="form1" runat="server">
        ...
        <telerik:RadScriptManager ID="RadScriptManager1" runat="server">
            <Scripts>
                ...
                <asp:ScriptReference Assembly="Telerik.Web.UI" Name="Telesrik.Web.UI.Common.jQueryInclude.js">
                </asp:ScriptReference>
            </Scripts>
        ...
        <div class="panel-heading">
             <div style="float: left;"><h3 class="panel-title">子类别添加</h3></div>
           <div style="float:left;"> <p class="panel-subtitle" style="margin-left: 5px; font-weight: 100; margin-top:5px;">Subcategory addition</p></div>
            </div>
