...
namespace RepairCenterY.BackManagement
{
    public partial class TeacherAdd : System.Web.UI.Page
    {
        ...
        protected void Tianjia_Click(object sender, EventArgs e)
        {
            ...
            {
                if (Regex.IsMatch(Yonghuming.Text, @"^[\u4e00-\u9fa5a-zA-Z0-9]+$"))//同上
                {
                                                            ...
                                                            else
                                                            {
                                                                if (Regex.IsMatch(Lianxidianhua.Text, @"^(13[0-9]|14[5|7]|15[0|1|2|3|5|6|7|8|9]|18[0|1|2|3|5|6|7|8|9])\d{8}$"))//同上
                                                                {
                                                                    ...
                                                                    else
                                                                    {
                                                                                ...
                                                                                else
                                                                                {
                                                                                    ...
                                                                                    else
                                                                                    {
                                                                                        if (Regex.IsMatch(Xiangxidizhi.Text, @"^[\u4e00-\u9fa5a-zA-Z0-9]+$"))//同上
                                                                                        {
                                                                                            ...
                                                                                            bu.Add(mu);
                                                                                            Response.Write("<script>alert('添加成功');window.location.href='TeacherInformation.aspx';</script>");//同上
                                                                                        }
                                                                                        else
                                                                                        {
                                                                                            Response.Write("<script>alert('请输入后正确的详细地址');</script>");//同上
                                                                                        }
                                                                                    }
                                                                                }
                                                                            }
                                                                        ...
                                                                        {
                                                                            Response.Write("<script>alert('请选择正确的出生日期');</script>");//同上
                                                                        }
                                                                    }
                                                                }
                                                                else
            ...
            //bu.Add(mu);
            //Response.Write("<script>alert('添加成功');window.location.href='TeacherInformation.aspx';</script>");
        }
