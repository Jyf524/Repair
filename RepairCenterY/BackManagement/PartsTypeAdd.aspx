<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartsTypeAdd.aspx.cs" Inherits="RepairCenterY.BackManagement.PartsTypeAdd" %>
...
<body style="background-color:white;">
    <form id="form1" runat="server">
        ...
        <%--<div style="margin-left: 13%; margin-top: 21%;">
            <label style="line-height:34px;margin-right:10px;font-size:14px;">配件类别:</label>
            <telerik:radtextbox id="txtPartTypeName" runat="server" MaxLength="16" labelwidth="64px" resize="None" width="160px" Height="34"></telerik:radtextbox>
        ...
        <div class="panel-heading">
             <div style="float: left;"><h3 class="panel-title">配件类别添加</h3></div>
