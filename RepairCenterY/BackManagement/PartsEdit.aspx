<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartsEdit.aspx.cs" Inherits="RepairCenterY.BackManagement.PartsEdit" %>
...
<body style="background-color:white;">
    <form id="form1" runat="server">
        ...
        <%--<div style="margin-left: 13%; margin-top: 21%;">
            <label style="line-height: 34px; margin-right: 10px;">配件名称:</label>
            <telerik:radtextbox id="txtPartName" runat="server" MaxLength="16" labelwidth="64px" resize="None" width="160px" height="34"></telerik:radtextbox>
        ...
        <div class="panel-heading">
             <div style="float: left;"><h3 class="panel-title">配件修改</h3></div>
           <div style="float:left;"> <p class="panel-subtitle" style="margin-left: 5px; font-weight: 100; margin-top:5px;">Part Edit</p></div>
            </div>
                          ...
                          <div class="form-group" style="margin-top:20px;">
                            <label for="focusedinput" class="col-sm-2 control-label">配件名称</label>
                              <div class="col-sm-8" style="width:78%; float:right; margin-top:-10px;">
                                  ...
                                  <asp:TextBox ID="PartName" runat="server" CssClass="form-control" MaxLength="16"></asp:TextBox>
