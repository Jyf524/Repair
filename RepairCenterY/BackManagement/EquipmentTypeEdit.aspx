<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentTypeEdit.aspx.cs" Inherits="RepairCenterY.BackManagement.EquipmentTypeEdit" %>
...
<body style="background-color:white;">
    <form id="form1" runat="server">
        ...
        <div class="panel-heading">
             <div style="float: left;"><h3 class="panel-title">父类别修改</h3></div>
           <div style="float:left;"> <p class="panel-subtitle" style="margin-left: 5px; font-weight: 100; margin-top:5px;">Parent category modification</p></div>
            </div>
                ...
                <div class="form-three widget-shadow">
                    <div class="form-horizontal">
                          <div class="form-group" style="margin-top:20px;">
                            <label for="focusedinput" class="col-sm-2 control-label">父类别名称</label>
