<%@ Page Title="用户修改页" Language="C#" EnableEventValidation="false" MasterPageFile="~/BackManagement/RepairCenter.Master" AutoEventWireup="true" CodeBehind="UserEdit.aspx.cs" Inherits="RepairCenterY.BackManagement.UserEdit" %>
...
<%--    <script type="text/javascript">
 ...
 <%--   <script type="text/javascript">
        ...
        {
            var abc = document.getElementById("Yonghuming").value;
        }
        </script>--%>
</asp:Content>
                ...
                <div class="form-three widget-shadow">
                    <div class="form-horizontal">
                        ...
                        <label for="focusedinput" class="col-sm-2 control-label">身份：</label>
                            <div class="col-sm-8">
                                        <div style="float: left;">
                                            <asp:RadioButton ID="bxdwyh" AutoPostBack="true" runat="server" Text="报修单位用户" GroupName="1" OnCheckedChanged="zbzxgly_CheckedChanged"/>
                                        </div>
                                        <div style="float: left; margin-left: 5px;">
                                            <asp:RadioButton ID="zbzxgly" AutoPostBack="true" runat="server" Text="装备中心管理员" GroupName="1" OnCheckedChanged="zbzxgly_CheckedChanged"/>
                                        </div>
                                        <div style="float: left; margin-left: 5px;">
                                            <asp:RadioButton ID="wxzxgly" AutoPostBack="true" runat="server" Text="维修中心管理员" GroupName="1" OnCheckedChanged="zbzxgly_CheckedChanged"/>
                                        </div>
                                        <div style="float: left; margin-left: 5px;">
                                            <asp:RadioButton ID="zdls" AutoPostBack="true" runat="server" Text="指导老师" GroupName="1" OnCheckedChanged="zbzxgly_CheckedChanged"/>
                                        </div>
                                        <div style="float: left; margin-left: 5px;">
                                            <asp:RadioButton ID="xs" AutoPostBack="true" runat="server" Text="学生" GroupName="1" OnCheckedChanged="zbzxgly_CheckedChanged"/>
                                        </div>
                                <%--<asp:DropDownList ID="Shenfen" runat="server" CssClass="form-control" OnSelectedIndexChanged="Shenfen_SelectedIndexChanged1" AppendDataBoundItems="true" AutoPostBack="true">
                                    <items>
