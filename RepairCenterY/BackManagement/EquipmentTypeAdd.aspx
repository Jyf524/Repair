<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EquipmentTypeAdd.aspx.cs" Inherits="RepairCenterY.BackManagement.EquipmentTypeAdd" %>
...
<body style="background-color:white;">
    <form id="form1" runat="server">
        ...
        <div class="panel-heading">
             <div style="float: left;"><h3 class="panel-title">父类别添加</h3></div>
           <div style="float:left;"> <p class="panel-subtitle" style="margin-left: 5px; font-weight: 100; margin-top:5px;">Parent category addition</p></div>
            </div>
