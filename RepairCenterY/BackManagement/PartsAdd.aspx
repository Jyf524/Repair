<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PartsAdd.aspx.cs" Inherits="RepairCenterY.BackManagement.PartsAdd" %>
...
<body style="background-color:white;">
    <form id="form1" runat="server">
        ...
        <%--<div style="margin-left: 13%; margin-top: 21%;">
            ...
            <telerik:radtextbox id="txtPartName" runat="server" labelwidth="64px" MaxLength="16" resize="None" width="160px" height="34"></telerik:radtextbox>
        ...
        <div class="panel-heading">
             <div style="float: left;"><h3 class="panel-title">配件添加</h3></div>
