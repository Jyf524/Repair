<%@ Page Title="维修中心管理" Language="C#" MasterPageFile="~/BackManagement/RepairCenter.Master" AutoEventWireup="true" CodeBehind="RepairManagementZB.aspx.cs" Inherits="RepairCenterY.BackManagement.RepairManagement" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <telerik:RadAjaxManager runat="server" ID="RadAjaxManager1">
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="ddlUnitsInfo">
                <UpdatedControls>
            ...
            <telerik:AjaxSetting AjaxControlID="dpstarttime">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadButton1" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
            <telerik:AjaxSetting AjaxControlID="dpendtime">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="RadButton1" UpdatePanelCssClass="" />
                </UpdatedControls>
            </telerik:AjaxSetting>
...
<asp:DropDownList ID="ddlPartName" runat="server" Width="160px" Height="34px" AppendDataBoundItems="True">
                                    ...
                                    <%--<form class="navbar-form navbar-left" style="margin-top: -20px; text-align: center;">--%>
                                        <%--<div class="input-group" style="width: 1350px;">--%>
                                            ...
                                            <div style="float: left; margin-left: 10px; line-height: 34px;">报修时间：</div>
                                            ...
                                            <div style="float: left; margin-left: 10px; width: 195px;">
                                                <telerik:RadDatePicker ID="dpendtime" runat="server" LabelWidth="64px" Resize="None" Width="175px" Height="34px" Culture="zh-CN"></telerik:RadDatePicker>
                                            </div>
                                        </div>--%>
...
<%--                                        <div style="margin-left: 1265px; margin-top: -34px;">
                                    ...
                                    <div class="content_main" style="margin-top: 50px;">
                                        <telerik:RadGrid ID="RadGrid1" runat="server" CellSpacing="0" Culture="zh-CN" DataKeyNames="DeclarationID" GridLines="None" OnNeedDataSource="RadGrid1_NeedDataSource" OnItemDataBound="RadGrid1_ItemDataBound" Skin="Metro" OnItemCommand="RadGrid1_ItemCommand">
                                            ...
                                            <MasterTableView NoMasterRecordsText="暂无数据" AllowPaging="true" DataKeyNames="DeclarationID" PageSize="10" AutoGenerateColumns="false" ClientDataKeyNames="DeclarationID">
                                                <Columns>
                                                    ...
                                                    <telerik:GridTemplateColumn HeaderText="操作">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="btndeal" runat="server" CommandName="sholi" CommandArgument='<%#Eval("DeclarationID") %>'>受理</asp:LinkButton>
                                                            ...
                                                            <asp:LinkButton ID="LinkButton4" runat="server" CommandName="qh" CommandArgument='<%#Eval("DeclarationID") %>'>确认取回</asp:LinkButton>
                                                        </ItemTemplate>
                                                    </telerik:GridTemplateColumn>
                                                </Columns>
