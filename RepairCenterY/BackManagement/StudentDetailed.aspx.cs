...
{
    public partial class StudentDetailed : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //zhenshixingming.Text = cmd.ExecuteScalar().ToString();//同上
            ...
            //cmd = new SqlCommand(sql, conn);
            //tianjiashijian.Text = cmd.ExecuteScalar().ToString();//同上
        }
