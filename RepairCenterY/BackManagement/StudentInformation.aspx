<%@ Page Title="学生列表页" Language="C#" MasterPageFile="~/BackManagement/RepairCenter.Master" AutoEventWireup="true" CodeBehind="StudentInformation.aspx.cs" Inherits="RepairCenterY.BackManagement.StudentInformation" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
                <script type="text/javascript">
                    ...
                    //    }
                    //    else {
                    //        window.location.href = "StudentEdit.aspx?" + "UserID=" + encodeURI(UserID);
                    //    }
                    //}
                    ...
                    //    }
                    //    else {
                    //        window.location.href = "StudentDetailed.aspx?" + "UserID=" + encodeURI(UserID);
                    //    }
                    //}
    </script>
<%--    <style type="text/css">
  ...
  <div class="container-fluid">
					...
					<div class="panel panel-headline">
						<div class="panel-heading">
							...
							<p class="panel-subtitle" style="float:left;margin-top:-30px;margin-left:100px">User Detailed</p>
						</div>
						<div class="panel-body">
							<div class="col-md-6" style="width:100%;float:left;margin-top:-30px">
							<!-- BASIC TABLE -->
                        <div class="panel" style="width: 100%;">
                            <div class="panel-body">
                                ...
                                <form class="navbar-form navbar-left" style="margin-top: -20px; text-align: center;">
                                    ...
                                    <div class="machine" style="float: left;width:14%;margin-left:-5%">
                                    <telerik:RadTextBox ID="RadTxtSearchName" runat="server" LabelWidth="64px" Resize="None" Width="66%" Height="34px" style="margin-left:7%"></telerik:RadTextBox>
                                        ...
                                        <div class="RepairTimeWord" style="float: left; margin-left: -1%; line-height: 35px;width:12%">
                                            添加时间：
                                        </div>
                                        <div class="RepairTime1" style="float: left; width: 10%;margin-left:-5%">
                                    ...
                                    <div style="margin-left:55%;width:10%">
                                        <span class="input-group-btn">
                                           <telerik:RadButton ID="chaxun" runat="server" Text="查询" Skin="Metro" BackColor="#00A0F0" ForeColor="White" Width="63px" Height="30px" BorderColor="#00A0F0" OnClick="chakan_Click"></telerik:RadButton>
                                            </span>
                                    </div>
                                </form>
                                    </div>
                        ...
                        <div class="panel-body">
									<p class="demo-button"  style="float:right;">
                                        <telerik:RadButton ID="bianji" runat="server" Text="修改" Height="34px" Width="74px" BackColor="White" Skin="Metro" CssClass="btn-default"  OnClick="bianji_Click"></telerik:RadButton>
										 ...
										 <%--<telerik:RadButton ID="chakan" runat="server" Text="查看" Height="34px" Width="74px" BackColor="White" Skin="Metro" CssClass="btn-default" OnClick="chakan_Click1" ></telerik:RadButton>--%>
									</p>
                                    </div>
						</div>
					</div>
