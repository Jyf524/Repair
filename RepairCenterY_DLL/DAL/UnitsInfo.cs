...
namespace Maticsoft.DAL
{
	...
	public partial class UnitsInfo
	{
		...
		public Maticsoft.Model.UnitsInfo GetModel(string UnitID)
		{
			...
			strSql.Append(" UnitID,UnitName,UnitCode,UnitPhone,Unitprovince,UnitCity,UnitAddress,UnitUserID,AddTime,BBB2,BBB3,BBB4,BBB5 ");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select UnitID,UnitName,UnitCode,UnitPhone,Unitprovince,UnitCity,UnitAddress,UnitUserID,AddTime,BBB2,BBB3,BBB4,BBB5 ");
			strSql.Append(" FROM UnitsInfo ");
			if(strWhere.Trim()!="")
			{
		...
		*/
        ...
        public Maticsoft.Model.UnitsInfo GetModelyyy(string UnitID)
        {
            ...
            strSql.Append(" UnitID,UnitName,UnitCode,UnitPhone,Unitprovince,UnitCity,UnitAddress,UnitUserID,AddTime,BBB2,BBB3,BBB4,BBB5 ");
            strSql.Append(" from UnitsInfo ");
            strSql.Append(" where UnitName='" + UnitID + "' ");
            Maticsoft.Model.UnitsInfo model = new Maticsoft.Model.UnitsInfo();
            DataSet ds = DbHelperSQL.Query(strSql.ToString());
            if (ds.Tables[0].Rows.Count > 0)
            {
